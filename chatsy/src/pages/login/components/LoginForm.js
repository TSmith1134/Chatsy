export function LoginForm({username, password, userRef, errRef, loginError, setUsername, setPassword, setConfirmPassword}){
    ...
    <form>
      ...
      <input value={username} required ref={userRef} typeof="text" name="inputUsername" id="inputUsername" placeholder="Username:" onChange={(e) => { setUsername(e.target.value);} }></input>
